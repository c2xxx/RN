                ...
                <View style={styles.bg}>
                    <View style={styles.dialog}>
                        ...
                        <View style={styles.dialogBtnView}>
                            <TouchableOpacity style={styles.dialogBtnViewItem} onPress={this.props._dialogLeftBtnAction}>
                                <Text style={styles.leftButton}>
                                    {this.props._dialogLeftBtnTitle}
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.dialogBtnViewItem} onPress={this.props._dialogRightBtnAction}>
